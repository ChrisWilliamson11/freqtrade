...
from freqtrade.freqai.base_models.BasePyTorchRegressorLSTM import BasePyTorchRegressor
...
from freqtrade.freqai.torch.PyTorchModelTrainerLSTM import PyTorchLSTMTrainer
