...
class NASOSv4(IStrategy):
    ...
    def custom_stoploss(self, pair: str, trade: 'Trade', current_time: datetime,
        ...
        # Increase stoploss by 0.01 for each 5-minute period
        stoploss_adjustment = periods_elapsed * 0.01
        ...
        if current_profit <= dynamic_stoploss:
            return 0.001  # Return positive value to trigger immediate market sell
        
        # Original profit-based stoploss logic
        HSL = self.pHSL.value
